...
class SignupActivity : AppCompatActivity() {
    ...
    @BindView(R.id.input_name) lateinit var nameText: EditText
    @BindView(R.id.input_lname) lateinit var lnameText: EditText
    @BindView(R.id.input_email) lateinit var emailText: EditText
    @BindView(R.id.input_mobile) lateinit var mobileText: EditText
    @BindView(R.id.input_password) lateinit var passwordText: EditText
    @BindView(R.id.input_reEnterPassword) lateinit var reEnterPasswordText: EditText
    @BindView(R.id.btn_signup) lateinit var signupButton: Button
